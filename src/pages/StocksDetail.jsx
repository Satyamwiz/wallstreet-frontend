...
import { Activity, TrendingUp, Building, History, Bookmark } from "lucide-react";
...
const StocksDetail = () => {
  ...
  return (
    <div className="stocks-detail-container">
      ...
      {passedState.stock && (
        <>
          {/* Header Section with dynamic price and bookmark toggle */}
            ...
            {activeTab === "info" && (
              <div className="info-section">
                <div className="info-card"  >
                    ...
                    <p className="para">
                      {infostock ? infostock.name :passedState.stock.name} ({infostock ? infostock.ticker :passedState.stock.ticker}) is a leading company in the {infostock ? infostock.sector :passedState.stock.sector} sector, 
                      specifically focusing on {infostock ? infostock.subsector :passedState.stock.subsector}. With a market capitalization of {infostock ? infostock.marketcap :passedState.stock.marketcap},
                      it has established itself as a significant player in the industry.
                    </p>
                    <p className="para">
                      The company reported an annual revenue of {infostock ? infostock.revenue :passedState.stock.revenue} with year-over-year growth 
                      of {infostock ? infostock.yoy_growth :passedState.stock.yoy_growth}. The profit after tax (PAT) stands at {infostock ? infostock.pat :passedState.stock.pat}, 
                      showing a growth of {infostock ? infostock.profit_growth :passedState.stock.profit_growth}.
                    </p>
